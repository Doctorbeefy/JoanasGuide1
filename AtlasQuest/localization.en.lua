...
-------------INST44 / tauren1------------
Inst44Story = "The green, verdant plains of Mulgore are home to the noble tauren. Mulgore is nestled in the foothills of the Stonetalon Mountains to the north, and protected by a natural wall of mountains on all sides. The only pass through these mountains leads into the Southern Barrens to the east. A land of windswept mesas and grassy plains, Mulgore is the tauren's ancestral homeland. Centaur often send raiding parties into Mulgore, and the tauren, now with the help of their Horde allies, beat them back. Tauren are naturally a nomadic people, and their tent cities are scattered across the landscape and change with the seasons and the weather. Now that they are members of the Horde, the tauren have constructed several permanent settlements, including fortified Dalsh-Beran and their capital of Thunder Bluff. Mulgore provides bounty for the hunt, as a diversity of wild beasts roam the rolling plains and climb the foothills of the surrounding range. In the northern section of Mulgore, the mesas of Thunder Bluff tower above the plains, casting long shadows. Bloodhoof Village is centrally located and surrounded by the clear waters of Stonebull Lake, and further south on the protected cliffs of Red Cloud Mesa, Camp Narache stands as the principal training camp for all young tauren."
Inst44Caption = "Tauren 1-6"
Inst44QAA = "0 Quests"
Inst44QAH = "1 Quests"

--QUEST1 Horde

Inst44Quest1_HORDE = "1. The Hunt Begins"
Inst44Quest1_HORDE_Attain = "1"
Inst44Quest1_HORDE_Level = "2"
Inst44Quest1_HORDE_Aim = "Grull Hawkwind in Camp Narache wants you to bring him 7 Plainstrider Feathers and 7 pieces of Plainstrider Meat."
Inst44Quest1_HORDE_Location = "Grull Hawkwind (Stranglethorn Vale - Booty Bay; "..YELLOW.."45,77 "..WHITE..")"
Inst44Quest1_HORDE_Note = "You have a promising air about you, and will prove yourself to the tribe. Perhaps someday soon you will be welcomed into the great city of Thunder Bluff. But before that can happen you must prove yourself to my father, Chief Hawkwind. Up here on Red Cloud Mesa we pride ourselves on keen hunting skills. Tauren hunt out of necessity and for sport. Our supply of meats has run low and we require feathers for clothing. Hunt the nearby plainstriders and prove yourself by resupplying the village."
Inst44Quest1_HORDE_Prequest = "No"
Inst44Quest1_HORDE_Folgequest = "Yes, The Hunt Continues"
Inst44Quest1PreQuest_HORDE = "False"

Inst44Quest1name1_HORDE = "Nomadic Belt"
Inst44Quest1name2_HORDE = "Painted Chain Gloves"
